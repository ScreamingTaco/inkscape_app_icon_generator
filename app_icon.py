...
class GenerateIconsEffect(inkex.Effect):
    ...
    def effect(self):
        ...
        if passing == False:
            ...
            #inkex.errormsg( "currentFileName = <" + currentFileName + ">")
            
            #saveDir = os.path.expanduser("~") #saves icons to the home directory
            if ios_icons == "true":
                self.makePath(ios_path)

                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-1024x1024@1x.png -h 1024 -w 1024")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-1024x1024@1x.png -h 1024 -w 1024")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-83.5x83.5@2x.png -h 167 -w 167")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-76x76@2x.png -h 152 -w 152")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-76x76@1x.png -h 76 -w 76")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-60x60@3x.png -h 180 -w 180")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-60x60@2x.png -h 120 -w 120")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-40x40@3x.png -h 120 -w 120")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-40x40@2x.png -h 80 -w 80")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-40x40@1x.png -h 40 -w 40")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-29x29@3x.png -h 87 -w 87")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-29x29@2x.png -h 58 -w 58")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-29x29@1x.png -h 29 -w 29")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-20x20@3x.png -h 60 -w 60")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-20x20@2x.png -h 40 -w 40")
                os.system("inkscape " + currentFileName + "  --export-area-page --export-filename=" + ios_path + "Icon-App-20x20@1x.png -h 20 -w 20")
            ...
            if android_mipmap == "true" or android_drawable == "true":
                ...
                #os.system("inkscape --export-filename=" + path + "Icon-xxxhdpi.png -h 192 -f " + currentFileName)
